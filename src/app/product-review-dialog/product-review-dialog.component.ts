...
@Component({
  ...
  styleUrls: ['./product-review-dialog.component.css']
})
export class ProductReviewDialogComponent implements OnInit {
  ...
  constructor(private dialogRef                    : MatDialogRef<ProductReviewDialogComponent>,
              private doalog                       : MatDialog,
              ...
              @Inject(MAT_DIALOG_DATA) public data : ProductReviewDialogComponent,
              public commonService         : CommonService) { }

  ngOnInit() {

    this.productDetailId = this.data['PRODUCT_DETAIL_ID']
