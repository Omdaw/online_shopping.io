...
export class ApplicationConstants  {
    ...
    public static googleClientId                                                = environment.googleClientId;
    public static facebookClientId                                              = environment.facebookClientId;
    public static googleMapsKey                                                 = environment.googleMapsKey;
    
    public static STORE_COMING_SOON_DEFAULT_TITLE                               = " Store Coming Soon "; //checklist-store-coming-soon-default-title
}